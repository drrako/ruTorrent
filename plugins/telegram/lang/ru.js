...
theUILang.telegramTemplateHelp = "Доступные подстановки: {STATE}, {TORRENT}, {HASH}, {LINK}. Используется Markdown Telegram; {LINK} добавляет HTTP(S)-ссылку из комментария торрента.";
