...
theUILang.telegramTemplateHelp = "Доступные подстановки: {STATE}, {TORRENT}, {HASH}, {LINK}. Все шаблоны используют одну структуру; применяется Markdown Telegram, а {LINK} добавляет HTTP(S)-ссылку для завершённых торрентов.";
theUILang.telegramEventAdded = "Добавлен";
theUILang.telegramEventResumed = "Возобновлён";
