...
theUILang.telegramTemplateHelp = "Available placeholders: {STATE}, {TORRENT}, {HASH}, {LINK}. All defaults use the same structure; Telegram Markdown is enabled and {LINK} is used for finished HTTP(S) comments.";
theUILang.telegramEventAdded = "Added";
theUILang.telegramEventResumed = "Resumed";
